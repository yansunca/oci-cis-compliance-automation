-- Fix Finding Detail native detail CSV download resolution.
--
-- Live Function-loaded evidence artifacts use Object Storage source locators
-- such as oci://<bucket>/<run_id>/files/<file>. Older local loads used
-- reports/<file>. Resolve detail CSV artifacts by immutable file name and role
-- so APEX links work for both layouts.
